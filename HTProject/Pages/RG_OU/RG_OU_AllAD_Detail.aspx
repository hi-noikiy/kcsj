<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="True"
    Inherits="HTProject.Pages.RG_OU.RG_OU_AllAD_Detail" Title="数据明细" CodeBehind="RG_OU_AllAD_Detail.aspx.cs" %>
            ...
            <td id="tdContainer" valign="top" align="center" runat="server">
                ...
                <table width="100%" cellspacing="1" id="ryInfo">
                    ...
                    <tr>
                        ...
                        <script type="text/javascript">
                            function OpenUrl() {
                                OpenWindow('../RG_QYUser/RG_QYUser_Add_Card.aspx?ParentRowGuid=<%=Request.QueryString["ParentRowGuid"]%>&DWGuid=<%=Request.QueryString["RowGuid"]%>', 800, 700);
                            }
                        </script>
                            <epoint:Button ForeColor="black" MouseOverClass="ButtonAdd" CssClass="ButtonAddNoBg"
                                ID="btnAddRecord" OnClientClick="OpenUrl();return false;" runat="server" Text="新增记录" /><br />
                            <asp:DataGrid ID="DGRY" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="修改">
                                        <ItemStyle HorizontalAlign="Center" Width="40"></ItemStyle>
                                        <ItemTemplate>
                                            <a href='javascript:OpenWindow("../RG_QYUser/RG_QYUser_Edit_Card.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>&DWGuid=<%#DataBinder.Eval(Container.DataItem,"DWGuid")%>")'>
