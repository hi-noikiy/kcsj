<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADLogin.aspx.cs" Inherits="HTProject.ADLogin" %>
...
<body id="userlogin_body">
    ...
    <div id="panSiteFactory">
        <div id="siteFactoryLogin">
            <div id="sysname" style='font-size: 32pt; color: White; font-family: 新宋体;vertical-align:middle; text-align:center;'>
                                    ...
                                    <div class="user_main_box">
                                        <ul>
                                            ...
                                            <li class="user_main_input">
                                                <input class="TxtUserNameCssClass" id="account" maxlength="20" name="account" runat="server" autocomplete="off" />
                                            </li>
                                        </ul>
                                        <ul>
