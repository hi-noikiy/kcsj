...
namespace HTProject.Pages.RG_QYUser
{
    ...
    public partial class RG_QYUser_List : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    string url = "window.location.href='RG_QYUser_List.aspx";
        ...
        protected void btnDel_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < Datagrid1.Items.Count; i++)
            {
                ...
                if (chk.Checked)
                {
                    ...
                    //{
                    RG_DW.DeleteByStatus("1", oListPage.TableDetail.SQL_TableName, " RowGuid='" + oListPage.TableDetail.SQL_TableName + "' ");
