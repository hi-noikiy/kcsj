<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="true"
    Inherits="HTProject.Pages.RG_QYUser.RG_QYUserAD_List" Title="数据记录列表" CodeBehind="RG_QYUserAD_List.aspx.cs" %>
                        ...
                        <td align="center" colspan="2">
                            <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="单位名称" SortExpression="DWGuid">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="注册印章号" SortExpression="YinZhangNo">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="证件号码" SortExpression="IDNum">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.IDNum") %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>--%>
                                    ...
                                    <%--<asp:TemplateColumn HeaderText="修改">
                                        <ItemStyle HorizontalAlign="Center" Width="40"></ItemStyle>
                                        <ItemTemplate>
                                            <%# new HTProject_Bizlogic.DB_RG_DW().GetOperateButton(DataBinder.Eval(Container, "DataItem.RowGuid"), DataBinder.Eval(Container, "DataItem.Status"), "RG_QYUser_Edit.aspx", "../../../images/add1.gif")%>
