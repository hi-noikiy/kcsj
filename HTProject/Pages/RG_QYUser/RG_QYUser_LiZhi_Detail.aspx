<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin_FixHead.master" AutoEventWireup="true"
    Inherits="HTProject.Pages.RG_QYUser.RG_QYUser_LiZhi_Detail" Title="查看数据明细" CodeBehind="RG_QYUser_LiZhi_Detail.aspx.cs" %>
        ...
        <ContentTemplate>
            <div id="Div_ControlNoTop">
                <table border="0" cellpadding="0" cellspacing="0" runat="server" id="tabOP" width="500px">
                    <tr>
                        <td>
                            <epoint:Button ID="btnPass" runat="server" Text="允许离职" CssClass="ButtonConNoBg" MouseOverClass="ButtonCon"
                                OnClientClick="return window.confirm('确定允许离职？');" OnClick="btnPass_Click"></epoint:Button>
                        </td>
                        <td>
                            <epoint:Button ID="btnNoPass" runat="server" Text="不允许离职" CssClass="ButtonConNoBg"
                                OnClick="btnNoPass_Click" MouseOverClass="ButtonCon" OnClientClick="return window.confirm('确定不允许离职？');">
                            </epoint:Button>
                        </td>
                        <td style="width: 100%">
                            &nbsp;
            ...
            <td id="tdContainer" valign="top" align="center" runat="server">
                <table width="100%" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="TableSpecial" width="35%" height="26" align="left">
                            <asp:Label ID="ryzz_2019" runat="server" MaxLength="100" Width="80%"></asp:Label>
                        </td>
                        <td class="TableSpecial1" width="15%">
                            发证机关:
                        </td>
                        <td class="TableSpecial" width="35%" height="26" align="left">
                            <asp:Label ID="fzjg_2019" runat="server" MaxLength="100" Width="80%"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="TableSpecial1" width="15%">
                        ...
                        <td class="TableSpecial" width="35%" height="26" align="left">
                            <asp:Label ID="mz_2019" runat="server" MaxLength="100" Width="80%"></asp:Label>
                        </td>
                        <td class="TableSpecial1" width="15%">
                            出生日期:
                        </td>
                        <td class="TableSpecial" width="35%" height="26" align="left">
                            <asp:Label ID="csrq_2019" runat="server" InputDateType="Input" Character="HX" Width="120px"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="TableSpecial1" width="15%">
