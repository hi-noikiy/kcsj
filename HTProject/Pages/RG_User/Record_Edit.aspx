<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin_FixHead.master" AutoEventWireup="True"
    Inherits="HTProject.Pages.RG_User.Record_Edit" Title="修改会员信息" CodeBehind="Record_Edit.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            try {
                ...
                document.getElementById('<%=PINCode_2010.ClientID %>').value = results;
            }
            catch (err) {
                alert(err.message);
            }
                    ...
                    <tr>
                        ...
                        <td >
                            <epoint:Button ID="btnInitEPwd" CssClass="ButtonOkNoBg" MouseOverClass="ButtonOkNoBg"
                                Text="初始PIN" runat="server" CausesValidation="false" OnClientClick="Validate();return false;">
                            </epoint:Button>
                        </td>
                        <td>
                    ...
                    <td id="tdContainer" valign="top" align="center" runat="server">
                        ...
                        <table width="100%" cellspacing="1" align="center">
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                    <epoint:TextBox ID="PINCode_2010" runat="server" contenteditable="false"></epoint:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="TableSpecial1" width="15%">
