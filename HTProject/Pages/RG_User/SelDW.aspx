<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="true"
    Inherits="HTProject.Pages.RG_User.SelDW" Title="单位选择列表" CodeBehind="SelDW.aspx.cs" %>
                            ...
                            <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="15" BorderWidth="1px"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            <input type="button" class="Btnbg" value="选择" onclick="SelDW('<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>','<%# DataBinder.Eval(Container, "DataItem.EnterPriseName")%>','<%# DataBinder.Eval(Container, "DataItem.ZuZhiJGDM")%>')" />
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
