<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin_FixHead.master" AutoEventWireup="true"
    Inherits="HTProject.Pages.RG_QYZiZhi.RG_QYZiZhi_Edit" Title="修改数据记录" CodeBehind="RG_QYZiZhi_Edit.aspx.cs" %>
                        ...
                        <table width="100%" cellspacing="1" align="center">
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                    <epoint:TextBox ID="FaZhengJG_2020" runat="server" MaxLength="100" AllowNull="false"
