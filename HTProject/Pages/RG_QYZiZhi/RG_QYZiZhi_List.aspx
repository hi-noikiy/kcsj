<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="true"
    Inherits="HTProject.Pages.RG_QYZiZhi.RG_QYZiZhi_List" Title="数据记录列表" CodeBehind="RG_QYZiZhi_List.aspx.cs" %>
                            ...
                            <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                                ...
                                <Columns>
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkAdd" runat="server" Enabled='<%# new HTProject_Bizlogic.DB_RG_DW().CanOperate(DataBinder.Eval(Container, "DataItem.Status")) %>'></asp:CheckBox>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="单位名称" SortExpression="ZiZhiText">
                                        <ItemTemplate>
                                            <%# RG_DW.GetDWName( DataBinder.Eval(Container, "DataItem.DWGuid")) %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="资质类别" SortExpression="ZiZhiText">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.ZiZhiText") %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="资质编号" SortExpression="ZiZhiCode">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.ZiZhiCode") %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="资质截止日期" SortExpression="ZiZhiEndDate">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.ZiZhiEndDate", "{0:yyyy-MM-dd}") %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <%--<asp:TemplateColumn HeaderText="资质类别Code" SortExpression="ZiZhiTextCode">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="查看">
                                        ...
                                        <ItemTemplate>
                                            <%# new HTProject_Bizlogic.DB_RG_DW().GetViewButton(DataBinder.Eval(Container, "DataItem.RowGuid"), DataBinder.Eval(Container, "DataItem.Status"), "RG_QYZiZhi_Detail.aspx", "../../../images/bigview.gif")%>
                                            <%--<a href='javascript:OpenWindow("RG_QYZiZhi_Detail.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>")'>
                                    ...
                                    <asp:TemplateColumn HeaderText="修改">
                                        <ItemStyle HorizontalAlign="Center" Width="40"></ItemStyle>
                                        <ItemTemplate>
                                            <%# new HTProject_Bizlogic.DB_RG_DW().GetOperateButton(DataBinder.Eval(Container, "DataItem.RowGuid"), DataBinder.Eval(Container, "DataItem.Status"), "RG_QYZiZhi_Edit.aspx", "../../../images/add1.gif","list")%>
