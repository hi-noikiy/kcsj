<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="true"
    Inherits="HTProject.Pages.RG_XMBeiAn.RG_XMBeiAn_List" Title="数据记录列表" CodeBehind="RG_XMBeiAn_List.aspx.cs" %>
                            ...
                            <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                                ...
                                <Columns>
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkAdd" runat="server" Enabled='<%# new HTProject_Bizlogic.DB_RG_DW().CanOperate2(DataBinder.Eval(Container, "DataItem.Status")) %>'></asp:CheckBox>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="查看">
                                        ...
                                        <ItemTemplate>
                                            <%# new HTProject_Bizlogic.DB_RG_DW().GetViewButton2(DataBinder.Eval(Container, "DataItem.RowGuid"), DataBinder.Eval(Container, "DataItem.Status"), "RG_XMBeiAn_Detail.aspx", "../../../images/bigview.gif")%>
                                            <%--<a href='javascript:OpenWindow("RG_XMBeiAn_Detail.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>")'>
