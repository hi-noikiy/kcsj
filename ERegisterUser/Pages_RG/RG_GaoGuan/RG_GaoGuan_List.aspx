<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="True"
    Inherits="EpointRegisterUser.Pages_RG.RG_GaoGuan.RG_GaoGuan_List" CodeBehind="RG_GaoGuan_List.aspx.cs" 
    Title="数据记录列表" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>			
		...
		function OpenUrl()
		{		  
		          OpenWindow('RG_GaoGuan_Add.aspx?ParentRowGuid=<%=Request.QueryString["ParentRowGuid"]%>',800,700);
		}
...
<asp:TemplateColumn HeaderText="PGuid" SortExpression="PGuid">
<ItemTemplate>
<%# DataBinder.Eval(Container, "DataItem.PGuid") %>
</ItemTemplate>
</asp:TemplateColumn>
...
<ItemTemplate>
<a href='javascript:parent.OpenDiagWin2("查看明细","RG_GaoGuan_Detail.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>")'>
...
<ItemStyle HorizontalAlign="Center" width=40></ItemStyle>
<ItemTemplate>
<a href='javascript:parent.OpenDiagWin2("修改记录","RG_GaoGuan_Edit.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>")'>
