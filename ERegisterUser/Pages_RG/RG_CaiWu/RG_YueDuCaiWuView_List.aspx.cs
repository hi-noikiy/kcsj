...
namespace EpointRegisterUser.Pages_RG.RG_CaiWu
{
    ...
    public partial class RG_YueDuCaiWuView_List : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster 
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (!Page.IsPostBack )
			{
                ...
                //ViewState["DWGuid"] = Request[ //Epoint.MisBizLogic2.DB.ExecuteToString(strSql);
				#region 是否联机表
