...
namespace EpointRegisterUser.Pages_RG.RG_DongTai
{
    ...
    public partial class RG_DongTai_DetailForCheck : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster
    {
        ...
        #endregion
        EpointRegisterUser_Bizlogic.CaiLiao CL = new EpointRegisterUser_Bizlogic.CaiLiao();
        ...
        protected void btnYes_Click(object sender, System.EventArgs e)
        {
            ...
            #region 同步附件
            CL.UpdateCaiLiaoProjectGuid(DWGuid, "企业-动态附件", DWGuid);
            CL.UpdateCaiLiaoProjectGuid(DWGuid, "企业-营业执照", DWGuid);
            CL.UpdateCaiLiaoProjectGuid(DWGuid, "企业-税务登记证书", DWGuid);
            CL.UpdateCaiLiaoProjectGuid(DWGuid, "企业-组织机构代码证", DWGuid);
            CL.UpdateCaiLiaoProjectGuid(DWGuid, "企业-商务部批准证书", DWGuid);
            #endregion
