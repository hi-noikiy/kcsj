<%@ Page Language="C#" MasterPageFile="~/WebMaster/Blank.master" AutoEventWireup="True"
    Inherits="EpointRegisterUser.Pages_RG.RG_RenShi.RG_RenShiInfo_DetailForCheck"
    CodeBehind="RG_RenShiInfo_DetailForCheck.aspx.cs" Title="审核人事信息" %>
        ...
        <tr>
            ...
            <td>
                <epoint:Button ID="btnYes" runat="server" Text="审核通过" CssClass="ButtonConNoBg" MouseOverClass="ButtonCon"
                    OnClick="btnYes_Click" OnClientClick="return window.confirm('确定审核不通过？');"></epoint:Button>
            </td>
            <td>
