...
namespace EpointRegisterUser.Pages_RG.RG_Other
{
    ...
    public partial class RG_OtherInfo_DetailForCheck : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster
    {
        ...
        protected void btnYes_Click(object sender, System.EventArgs e)
        {
            ...
            #region 同步附件
            CL.UpdateCaiLiaoProjectGuid(DWGuid, "企业-每月财务报表", DWGuid);
            CL.UpdateCaiLiaoProjectGuid(DWGuid, "企业-年度审计报告", DWGuid);
            #endregion
