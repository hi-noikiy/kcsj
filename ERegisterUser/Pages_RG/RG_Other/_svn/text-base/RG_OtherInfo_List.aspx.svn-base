<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="True"
    Inherits="EpointRegisterUser.Pages_RG.RG_Other.RG_OtherInfo_List" CodeBehind="RG_OtherInfo_List.aspx.cs" 
    Title="数据记录列表" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>			
		...
		function OpenUrl()
		{		  
		          OpenWindow('RG_OtherInfo_Add.aspx?ParentRowGuid=<%=Request.QueryString["ParentRowGuid"]%>',800,700);
		}
...
<asp:TemplateColumn HeaderText="上年度研发费用" SortExpression="ShangNianDuYFFY">
<ItemTemplate>
<%# DataBinder.Eval(Container, "DataItem.ShangNianDuYFFY") %>
</ItemTemplate>
</asp:TemplateColumn>
<asp:TemplateColumn HeaderText="薪酬总额" SortExpression="XinChouZongE">
<ItemTemplate>
...
<asp:TemplateColumn HeaderText="注册资本" SortExpression="ZhuCeZiBen">
<ItemTemplate>
...
<ItemTemplate>
<a href='javascript:parent.OpenDiagWin2("查看明细","RG_OtherInfo_Detail.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>")'>
...
<ItemStyle HorizontalAlign="Center" width=40></ItemStyle>
<ItemTemplate>
<a href='javascript:parent.OpenDiagWin2("修改记录","RG_OtherInfo_Edit.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>")'>
