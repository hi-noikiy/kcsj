<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPage.master" AutoEventWireup="true"
    Inherits="EpointRegisterUser.Pages.Pages_RG.RG_User.ChangeUserInfo" Title="修改个人信息" CodeBehind="ChangeUserInfo.aspx.cs" %>
            ...
            <div id="Div_ControlNoTop">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <epoint:Button ID="Button1" runat="server" Text="修改密码" CssClass="ButtonConNoBg" MouseOverClass="ButtonCon"
                                OnClientClick="OpenChangePwd();return false;"></epoint:Button>
                        </td>
                        <td style="display: none">
                            &nbsp;
                            <asp:Literal ID="litReturn" runat="server"><span id="spanReturn" class="location_btn" style="cursor:hand" onclick="javascript:history.go(-1)">返回</span></asp:Literal>
                        </td>
                    </tr>
                </table>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="35%" height="26" align="left">
                                    <asp:RadioButtonList ID="IsValid_2010" runat="server" RepeatDirection="Horizontal"
                                        RepeatLayout="Flow" Width="97%" Height="100%" style="display:none">
                                    </asp:RadioButtonList>
                                </td>
                            </tr>
                            <tr style="display: none">
