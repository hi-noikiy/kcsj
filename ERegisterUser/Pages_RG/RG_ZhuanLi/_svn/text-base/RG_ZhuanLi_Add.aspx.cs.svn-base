...
namespace EpointRegisterUser.Pages_RG.RG_ZhuanLi
{
    ...
    public partial class RG_ZhuanLi_Add : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster
    {
	...
	public int TableID=2026;		
        ...
        protected void btnAdd_Click(object sender, System.EventArgs e)
        {
            ...
            DWGuid_2026.Text = Request["DWGuid"];
            PGuid_2026.Text = Request["PGuid"];
            oAddPage.SaveTableValues(RowGuid, tdContainer, Request.QueryString["ParentRowGuid"]);

            CL_ZLJS.MisRowGuid = RowGuid;
            ...
            string url = "RG_ZhuanLi_Edit.aspx?RowGuid=" + RowGuid;
