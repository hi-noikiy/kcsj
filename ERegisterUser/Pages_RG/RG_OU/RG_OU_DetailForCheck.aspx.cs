...
namespace EpointRegisterUser.Pages.RG_OU
{
    ...
    public partial class RG_OU_DetailForCheck : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string RowGuid = Request["RowGuid"]; //Epoint.MisBizLogic2.DB.ExecuteToString(strSql);
