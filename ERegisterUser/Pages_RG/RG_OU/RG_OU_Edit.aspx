<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin_FixHead.master" AutoEventWireup="true"
    Inherits="EpointRegisterUser.Pages_RG.RG_OU.RG_OU_Edit" Title="修改单位信息" CodeBehind="RG_OU_Edit.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script>
        ...
        function OpenUrl() {
            OpenWindow('../RG_GaoGuan/RG_GaoGuan_Add.aspx?ParentRowGuid=<%=Request.QueryString["ParentRowGuid"]%>&DWGuid=<%=Request["DWGuid"]%>&PGuid=<%=Request["RowGuid"]%>', 400, 400);
        }
    </script>
                        ...
                        <table width="100%" cellspacing="1" align="center">
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="85%" colspan="3" height="26" align="left">
                                    <epoint:TextTreeView ID="tvYYD1" runat="server" DivHeight="450px" DivWidth="180px"
                                        ImgFolds="../../../Images/TreeImages" OnTreeNodePopulate="RegionTreeView_TreeNodePopulate"
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="85%" colspan="3" height="26" align="left">
                                    <epoint:TextTreeView ID="tvYYD2" runat="server" DivHeight="450px" DivWidth="180px"
                                        ImgFolds="../../../Images/TreeImages" OnTreeNodePopulate="RegionTreeView_TreeNodePopulate"
                                        RootNodeText="行政区划选择" TextCssClass="Inputtxt" Width="300px" OnlyReturnLeaf="true"
                                        InputType="Radio">
                                    </epoint:TextTreeView>
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="85%" colspan="3" height="26" align="left">
                                    <epoint:TextTreeView ID="tvYYD3" runat="server" DivHeight="450px" DivWidth="180px"
                                        ImgFolds="../../../Images/TreeImages" OnTreeNodePopulate="RegionTreeView_TreeNodePopulate"
                                        RootNodeText="行政区划选择" TextCssClass="Inputtxt" Width="300px" OnlyReturnLeaf="true"
                                        InputType="Radio">
                                    </epoint:TextTreeView>
