<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="true"
    Inherits="EpointRegisterUser.Pages.RG_OU.RG_OU_DetailForCheck" Title="审核企业信息"
    CodeBehind="RG_OU_DetailForCheck.aspx.cs" %>
        ...
        <ContentTemplate>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <epoint:Button ID="btnYes" runat="server" Text="审核通过" CssClass="ButtonConNoBg" MouseOverClass="ButtonCon"
                            OnClick="btnYes_Click" OnClientClick="return window.confirm('确定审核通过？');"></epoint:Button>
                    </td>
                    <td>
                        <epoint:Button ID="btnNo" CssClass="ButtonCancleNoBg" MouseOverClass="ButtonCancle"
                            Text="审核不通过" runat="server" CausesValidation="false" OnClientClick="return window.confirm('确定审核不通过？');">
                        </epoint:Button>
                    </td>
                </tr>
            </table>
                        ...
                        <table width="100%" cellspacing="1" align="center">
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="85%" colspan="3" height="26" align="left">
                                    ...
                                    <webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" SubmitButtonClass="backendbtn22"
