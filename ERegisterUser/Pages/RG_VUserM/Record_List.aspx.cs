    ...
    public partial class Record_List : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster
    {
        ...
        protected void btnDel_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < Datagrid1.Items.Count; i++)
            {
                ...
                if (chk.Checked)
                {
                    new ComDataSyn().DeleteWithKeyValue(DataSynTarget.BackEndToFront, "RG_VUserM", "RowGuid", Convert.ToString(Datagrid1.DataKeys[i]));
                    ...
                    new ComDataSyn().DeleteWithCondition(DataSynTarget.BackEndToFront, "RG_VUser", " VUserGuid='" + Datagrid1.DataKeys[i] + "'", "RowGuid");

                    Epoint.MisBizLogic2.DB.ExecuteNonQuery("delete from RG_VUser where VUserGuid='" + Datagrid1.DataKeys[i] + "'");
                }
            }
            this.RefreshGrid();
        }
