<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="true"
    Inherits="EpointRegisterUser.Pages.RG_Role.Record_List" Title="会员角色" CodeBehind="Record_List.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        function OpenUrl() {
            OpenDialogRefresh('Record_Add.aspx?ParentRowGuid=<%=Request.QueryString["ParentRowGuid"]%>', "", 500, 250);
        }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;<epoint:Button ForeColor="black" MouseOverClass="ButtonAdd" CssClass="ButtonAddNoBg"
                                                ID="btnAddRecord" OnClientClick="OpenUrl();return false;" runat="server" Text="新增角色" />
                                        </td>
                                        <td>
                        ...
                        <td align="center" colspan="2">
                            <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="是否默认角色" SortExpression="IsDefault">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    ...
                                    <asp:TemplateColumn HeaderText="查看">
                                        ...
                                        <ItemTemplate>
                                            <a href='javascript:OpenDialogArgs("Record_Detail.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>","",500,250)'>
