<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" Title="所有项目"
    AutoEventWireup="true" CodeBehind="BasicInfo_List_Status.aspx.cs" Inherits="EpointRegisterUser.Pages.RG_OU.BasicInfo_List_Status" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0" class="table">
        <tbody>
                ...
                <td class="Tablespecial1">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                &nbsp;<epoint:Button ID="btnExcel" MouseOverClass="ButtonCon" ForeColor="black" runat="server"
                                    Text="导出" CssClass="ButtonConNoBg" OnClientClick="AllAreaExcel();"></epoint:Button>
                            </td>
                ...
                <td align="center" colspan="2">
                    <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="企业信息">
                                <ItemStyle />
                                <ItemTemplate>
                                    <%# GetDWStatus( DataBinder.Eval(Container, "DataItem.DWGuid"))%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="动态信息">
                                <ItemStyle />
                                <ItemTemplate>
                                    <%# GetDTStatus(DataBinder.Eval(Container, "DataItem.DWGuid"))%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="财务信息">
                                <ItemStyle />
                                <ItemTemplate>
                                    <%# GetCWStatus(DataBinder.Eval(Container, "DataItem.DWGuid"))%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="人事信息">
                                <ItemStyle />
                                <ItemTemplate>
                                    <%# GetRSStatus(DataBinder.Eval(Container, "DataItem.DWGuid"))%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="其他事项">
                                <ItemStyle />
                                <ItemTemplate>
                                    <%# GetOtherStatus(DataBinder.Eval(Container, "DataItem.DWGuid"))%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="定期事项">
                                <ItemStyle />
                                <ItemTemplate>
                                    <%# GetDQStatus(DataBinder.Eval(Container, "DataItem.DWGuid"))%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
            ...
            <tr>
                <td colspan="2" id="report">
                    <asp:DataGrid ID="GridExcel" runat="server" CssClass="GridView" PageSize="1000" Width="100%"
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyField="RowGuid" BorderWidth="1px"
                        OnItemDataBound="GridExcel_ItemDataBound" EnableViewState="true" style="display:none">
                        <PagerStyle Visible="False"></PagerStyle>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="项目经理">
                                <ItemStyle Width="50px" />
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container, "DataItem.s_xiangMuJL") %>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="关联企业">
                                <ItemStyle Width="180px" />
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container, "DataItem.DWName")%>
                                </ItemTemplate>
