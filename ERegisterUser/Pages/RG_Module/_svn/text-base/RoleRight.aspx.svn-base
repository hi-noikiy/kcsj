<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin.Master" AutoEventWireup="true"
    CodeBehind="RoleRight.aspx.cs" Inherits="EpointRegisterUser.Pages.RG_Module.RoleRight"
    EnableEventValidation="false" Title="角色权限" %>
                    ...
                    <table height="100%" width="100%" align="center" height="380px">
                        <tr>
                            <td width="49%" class="TableSpecial" height="380px">
                                <fieldset>
                                    <iframe id="Iframe1" name="mailUser" src='GetRoleTree.aspx' frameborder="0" width="100%"
