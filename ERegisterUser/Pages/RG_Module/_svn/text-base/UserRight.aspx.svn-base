<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin.Master" AutoEventWireup="true"
    CodeBehind="UserRight.aspx.cs" Inherits="EpointRegisterUser.Pages.RG_Module.UserRight"
    EnableEventValidation="false" Title="用户权限" %>
                    ...
                    <table height="100%" width="100%" align="center" height="380px">
                        <tr>
                            <td width="49%" class="TableSpecial" height="380px">
                                <fieldset>
                                    <iframe id="Iframe1" name="mailUser" src='GetUserTree.aspx' frameborder="0" width="100%"
