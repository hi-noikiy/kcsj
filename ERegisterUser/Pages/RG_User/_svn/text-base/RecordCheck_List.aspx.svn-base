<%@ Page Language="C#" MasterPageFile="~/WebMaster/ContentPageNoTop.master" AutoEventWireup="true"
    Inherits="EpointRegisterUser.Pages.RG_User.RecordCheck_List" Title="会员管理" CodeBehind="RecordCheck_List.aspx.cs" %>
                            ...
                            <div id="Div_Control">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                     ...
                                     <%--   <td>
                                            <input type="hidden" id="hidSelectedFields" value="DispName" runat="server" />
                                        ...
                                        <%-- <td>
                                            &nbsp;<epoint:Button ForeColor="black" MouseOverClass="ButtonAdd" CssClass="ButtonAddNoBg"
                                                ID="btnAddRecord" OnClientClick="OpenUrl();return false;" runat="server" Text="添加会员" />
                                        </td>--%>
                                        <td>
                                         ...
                                         <td>
                                            <asp:RadioButtonList ID="statusSel" runat="server" AutoPostBack="true" RepeatDirection="Horizontal"
                                                ...
                                                <asp:ListItem Text="已审核" Value="1"></asp:ListItem>
                                                 <asp:ListItem Text="审核有效" Value="2"></asp:ListItem>
                                                    <asp:ListItem Text="审核未通过" Value="3"></asp:ListItem>
                        ...
                        <td align="center" colspan="2">
                            <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="登陆名" SortExpression="LoginID">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    ...
                                    <asp:TemplateColumn HeaderText="会员类别" SortExpression="UserType">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                       
                                        <ItemTemplate>
                                            <%# new Epoint.MisBizLogic2.Code.DB_CodeMain().GetCodeText_FromHash("RG_会员类别", Convert.ToString(DataBinder.Eval(Container, "DataItem.UserType"))) %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="审核">
                                        ...
                                        <ItemTemplate>
                                            <a href='javascript:OpenWindow("Record_Detail.aspx?RowGuid=<%#DataBinder.Eval(Container.DataItem,"RowGuid")%>",800,600)'>
