<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin_FixHead.Master" AutoEventWireup="True"
    Inherits="EpointRegisterUser.Pages.RG_User.Record_Add" Title="添加会员" CodeFile="Record_Add.aspx.cs" %>
                    ...
                    <tr>
                        ...
                        <td style="display:none">
                            <epoint:Button ID="btnInitEPwd" CssClass="ButtonOkNoBg" MouseOverClass="ButtonOkNoBg"
                                Text="读取证书" runat="server" CausesValidation="false" OnClientClick="CheckEPass();return false;">
                            </epoint:Button>
                        </td>
                        <td>
                ...
                <tr>
                    <td id="tdContainer" valign="top" align="center" runat="server">
                        ...
                        <table width="100%" cellspacing="1" align="center" id="tabContent">
                            ...
                            <tr id="trUserType" runat="server" style="display:none">
                                <td class="TableSpecial1" width="15%">
                                    <font style="font-weight: bold">会员类别</font>
                                </td>
                            ...
                            <tr id="trRoleList" runat="server" style="display:none">
                                <td class="TableSpecial1" width="15%">
                                    角色名称
                                </td>
                                <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="35%" height="26" align="left">
                                    <epoint:TextBox ID="DispName_2010" runat="server" MaxLength="200" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                ...
                                <td class="TableSpecial" width="35%" height="26" align="left">
                                    <epoint:TextBox ID="LoginID_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="TableSpecial" width="35%" height="26" align="left">
                                    <epoint:TextBox ID="Mobile_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                </td>
                                <td class="TableSpecial1" width="15%">
                            ...
                            <tr runat="server" id="trIdendity" style="display:none">
                                <td class="TableSpecial1" width="15%">
                                    证件类型
                                </td>
                                <td class="TableSpecial" width="35%" height="26" align="left">
                            ...
                            <tr runat="server" id="trDanwei">
                                ...
                                <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                    ...
                                    <asp:DropDownList ID="dpDanWeiGuid" runat="server" Width="39%" AutoPostBack="true" style="display:none"
                                        OnSelectedIndexChanged="dpDanWeiGuid_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td colspan="2">
                                </td>
                            </tr>
                            <tr id="trOuType" runat="server" style="display:none">
                                <td class="TableSpecial1" width="15%">
                                    单位类别
                                </td>
                            ...
                            <tr>
                                <td style="display: none">
                                    ...
                                    <epoint:TextBox ID="DelFlag_2010" runat="server" Text="0"></epoint:TextBox>
                                </td>
                            </tr>
                                ...
                                <td colspan="4">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left">
                                                <epoint:TextBox ID="Race_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="TableSpecial1" width="15%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left">
                                                <epoint:TextBox ID="HomeTel_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                            <td class="TableSpecial1" width="15%">
                                                办公电话
                                            </td>
                                            <td class="TableSpecial" width="35%" height="26" align="left">
                                                <epoint:TextBox ID="OfficeTel_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="TableSpecial1" width="15%">
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left">
                                                <epoint:TextBox ID="QQAccount_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                            <td class="TableSpecial1" width="15%">
                                                MSN号码
                                            </td>
                                            <td class="TableSpecial" width="35%" height="26" align="left">
                                                <epoint:TextBox ID="MSNAccount_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="TableSpecial1" width="15%">
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left">
                                                <epoint:TextBox ID="PostCode_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left">
                                                <epoint:TextBox ID="EMail_2010" runat="server" MaxLength="50" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                                ...
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="EMail_2010"
                                                    Display="Dynamic" ErrorMessage="电子邮箱：必填！"></asp:RequiredFieldValidator>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="TableSpecial1" width="15%">
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                                <epoint:TextBox ID="SuoZaiDi_2010" runat="server" MaxLength="500" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="TableSpecial1" width="15%">
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                                <epoint:TextBox ID="Address_2010" runat="server" MaxLength="500" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="TableSpecial1" width="15%">
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                                <epoint:TextBox ID="OtherContact_2010" runat="server" MaxLength="200" CssClass="inputtxt" Width="90%"></epoint:TextBox>
                                            </td>
                                        </tr>
                                        <tr style="display:none">
                                            <td class="TableSpecial1" width="15%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                                <epoint:TextBox TextMode="MultiLine" Height="80" CssClass="inputtxt" Width="90%" ID="ChangeLog_2010" runat="server"
                                                    MaxLength="200"></epoint:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td colspan="4">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="TableSpecial" colspan="3" height="26" align="left">
                                                <asp:CheckBoxList ID="cblOUTypeOU" RepeatLayout="Flow" runat="server" RepeatDirection="Horizontal"
                                                    Width="97%" Height="100%">
                                                </asp:CheckBoxList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="TableSpecial" width="35%" height="26" align="left" colspan="3">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="Dynamic"
                                                    ControlToValidate="EMail" ErrorMessage="电子邮箱：不符合格式要求！" EnableClientScript="true"
                                                    ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="red"></asp:RegularExpressionValidator>
