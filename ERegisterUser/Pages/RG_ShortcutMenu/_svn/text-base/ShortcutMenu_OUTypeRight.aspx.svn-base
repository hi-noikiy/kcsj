<%@ Page Language="C#" MasterPageFile="~/WebMaster/OpenWin.Master" AutoEventWireup="true"
    CodeBehind="ShortcutMenu_OUTypeRight.aspx.cs" Inherits="EpointRegisterUser.Pages.RG_ShortcutMenu.ShortcutMenu_OUTypeRight"
    EnableEventValidation="false" Title="企业类型授权" %>
    ...
    <table width="98%" align="center">
        <tr>
            <td valign="top" height="380px">
               <%-- <fieldset>
                    <legend>会员单位权限</legend>--%>
                    <table height="100%" width="100%" align="center" height="380px">
                        <tr>
                            <td width="49%" class="TableSpecial" height="380px">
                                <fieldset>
                                    <iframe id="Iframe1" name="mailUser" src='../RG_Module/GetOUTypeTree.aspx' frameborder="0" width="100%"
                            ...
                            <td width="49%" class="TableSpecial" height="380px">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <asp:ListBox ID="lstOUType" runat="server" Width="100%" SelectionMode="Multiple" Height="360px">
                                            </asp:ListBox>
                                        </td>
                                    </tr>
                                    <tr>
