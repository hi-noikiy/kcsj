<%@ Page Language="C#" MasterPageFile="~/WebMaster/MainpageNoLocation.master" AutoEventWireup="true"
    Inherits="EpointRegisterUser.Group.DataGroup_List" Title="数据归档列表" CodeBehind="DataGroup_List.aspx.cs" %>
                        ...
                        <td align="center" colspan="2">
                            <asp:DataGrid ID="Datagrid1" runat="server" CssClass="GridView" PageSize="20" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="归档名称" SortExpression="GroupName">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.GroupName") %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="排序号" SortExpression="OrderNum">
                                        <ItemTemplate>
