...
namespace EpointRegisterUser.Group
{
    ...
    public partial class DataGroup_Edit : Epoint.Frame.Bizlogic.BaseContentPage_UsingMaster
    {
        ...
        protected void btnEdit_Click(object sender, System.EventArgs e)
        {
            ...
            new ComDataSyn().UpdateWithKeyValue(DataSynTarget.BackEndToFront, "RG_DataGroup", "RowGuid", Request["RowGuid"]);
